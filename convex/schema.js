...
export default defineSchema({
    users: defineTable({
        name: v.string(),
        email: v.string(),
        tokenIdentifier: v.string(),//contain jwt token identifier provided by Clerk
        imageUrl: v.optional(v.string()),
    })
        .index("by_token", ["tokenIdentifier"])//THIS IS THERE TO SEARCH FOR A USER BY THEIR JWT TOKEN IDENTIFIER
